...
val stats : (string * decimal) [] =
  [|("4.2", 2724M); ("4.1", 40503M); ("4.0", 28450M); ("3.3", 590474M);
    ("3.2", 14660M); ("3.1", 165724M); ("3.0", 332499M); ("2.4", 379987M);
    ("2.3", 449589M); ("2.2", 276902M); ("2.1", 26177M); ("2.0", 77327M);
    ("1.1", 68568M); ("1.0", 17731M)|]*)
(**
